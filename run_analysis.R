...
train_data <- cbind(activity_train, train_set)
...
test_data <- cbind(activity_test, test_set)
...
write.table(mean_activity_data, file = "Tidy_data_Samsung_experiment.txt", row.names = FALSE)